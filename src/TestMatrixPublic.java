...
public class TestMatrixPublic {
	...
	String grid3 = "5,5;1;0,4;4,4;0,3,1,4,2,1,3,0,4,1;4,0;2,4,3,4,3,4,2,4;0,2,98,1,2,98,2,2,98,3,2,98";
	...
	public void testa0() throws Exception {
		String solution = The_Matrix_Solver.solve(grid0, "BF", false);
	...
	public void testa1() throws Exception {
		String solution = The_Matrix_Solver.solve(grid1, "BF", false);
	...
	public void testa2() throws Exception {
		String solution = The_Matrix_Solver.solve(grid2, "BF", false);
		solution = solution.replace(" ", "");
	...
	public void testa3() throws Exception {
		String solution = The_Matrix_Solver.solve(grid3, "BF", false);
		System.out.println(solution);
		solution = solution.replace(" ", "");
	...
	public void testa5() throws Exception {
		String solution = The_Matrix_Solver.solve(grid5, "BF", false);
		solution = solution.replace(" ", "");
	...
	public void testa6() throws Exception {
		String solution = The_Matrix_Solver.solve(grid6, "BF", false);
		solution = solution.replace(" ", "");
	...
	public void testa7() throws Exception {
		String solution = The_Matrix_Solver.solve(grid7, "BF", false);
		solution = solution.replace(" ", "");
	...
	public void testa8() throws Exception {
		String solution = The_Matrix_Solver.solve(grid8, "BF", false);
		solution = solution.replace(" ", "");
	...
	public void testa9() throws Exception {
		String solution = The_Matrix_Solver.solve(grid9, "BF", false);
		solution = solution.replace(" ", "");
	...
	public void testb1() throws Exception {
		String solution = The_Matrix_Solver.solve(grid1, "DF", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid1, solution));
	}
	...
	public void testb2() throws Exception {
		String solution = The_Matrix_Solver.solve(grid2, "DF", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid2, solution));
	}
	...
	public void testb3() throws Exception {
		String solution = The_Matrix_Solver.solve(grid3, "DF", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid3, solution));
	}
	...
	public void testb6() throws Exception {
		String solution = The_Matrix_Solver.solve(grid6, "DF", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid6, solution));
	}
	...
	public void testb7() throws Exception {
		String solution = The_Matrix_Solver.solve(grid7, "DF", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.",applyPlan(grid7, solution) );
	}
	...
	public void testb8() throws Exception {
		String solution = The_Matrix_Solver.solve(grid8, "DF", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.",applyPlan(grid8, solution));
	}
	...
	public void testb9() throws Exception {
		String solution = The_Matrix_Solver.solve(grid9, "DF", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid9, solution));
	}
	...
	public void testbz10() throws Exception {
		String solution = The_Matrix_Solver.solve(grid10, "DF", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid10, solution));
	}
	...
	public void testc0() throws Exception {
		String solution = The_Matrix_Solver.solve(grid0, "UC", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid0, solution));
	}
	...
	public void testc1() throws Exception {
		String solution = The_Matrix_Solver.solve(grid1, "UC", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid1, solution));
	}
	...
	public void testc2() throws Exception {
		String solution = The_Matrix_Solver.solve(grid2, "UC", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid2, solution));
	}
	...
	public void testc3() throws Exception {
		String solution = The_Matrix_Solver.solve(grid3, "UC", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid3, solution));
	}
	...
	public void testc4() throws Exception {
		String solution = The_Matrix_Solver.solve(grid4, "UC", false);
		assertTrue("The output actions do not lead to a goal state.", solution.equals("No Solution"));
	}
	
	@Test(timeout = 10000)
	public void testc5() throws Exception {
		String solution = The_Matrix_Solver.solve(grid5, "UC", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid5, solution));
	}
	...
	public void testc6() throws Exception {
		String solution = The_Matrix_Solver.solve(grid6, "UC", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid6, solution));
	}
	...
	public void testc7() throws Exception {
		String solution = The_Matrix_Solver.solve(grid7, "UC", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.",  applyPlan(grid7, solution));
	}
	...
	public void testc8() throws Exception {
		String solution = The_Matrix_Solver.solve(grid8, "UC", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid8, solution));
	}
	...
	public void testc9() throws Exception {
		String solution = The_Matrix_Solver.solve(grid9, "UC", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid9, solution));
	}
	...
	public void testd0() throws Exception {
		String solution = The_Matrix_Solver.solve(grid0, "ID", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid0, solution));
	}
	...
	public void testd1() throws Exception {
		String solution = The_Matrix_Solver.solve(grid1, "ID", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid1, solution));
	}
	...
	public void testd2() throws Exception {
		String solution = The_Matrix_Solver.solve(grid2, "ID", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid2, solution));
	}
	...
	public void testd3() throws Exception {
		String solution = The_Matrix_Solver.solve(grid3, "ID", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid3, solution));
	}
	...
	public void testd5() throws Exception {
		String solution = The_Matrix_Solver.solve(grid5, "ID", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid5, solution));
	}
	...
	public void testd6() throws Exception {
		String solution = The_Matrix_Solver.solve(grid6, "ID", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid6, solution));
	}
	...
	public void teste0() throws Exception {
		String solution = The_Matrix_Solver.solve(grid0, "GR1", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid0, solution));
	}
	...
	public void teste1() throws Exception {
		String solution = The_Matrix_Solver.solve(grid1, "GR1", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid1, solution));
	}
	...
	public void teste2() throws Exception {
		String solution = The_Matrix_Solver.solve(grid2, "GR1", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid2, solution));
	}
	...
	public void teste3() throws Exception {
		String solution = The_Matrix_Solver.solve(grid3, "GR1", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid3, solution));
	}
	...
	public void teste4() throws Exception {
		String solution = The_Matrix_Solver.solve(grid4, "GR1", false);
		assertTrue("The output actions do not lead to a goal state.", solution.equals("No Solution"));
	}
	
	@Test(timeout = 10000)
	public void teste5() throws Exception {
		String solution = The_Matrix_Solver.solve(grid5, "GR1", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid5, solution));
	}
	...
	public void teste6() throws Exception {
		String solution = The_Matrix_Solver.solve(grid6, "GR1", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid6, solution));
	}
	...
	public void teste7() throws Exception {
		String solution = The_Matrix_Solver.solve(grid7, "GR1", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid7, solution));
	}
	...
	public void teste8() throws Exception {
		String solution = The_Matrix_Solver.solve(grid8, "GR1", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid8, solution));
	}
	...
	public void teste9() throws Exception {
		String solution = The_Matrix_Solver.solve(grid9, "GR1", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid9, solution));
	}
	...
	public void testf0() throws Exception {
		String solution = The_Matrix_Solver.solve(grid0, "GR2", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid0, solution));
	}
	...
	public void testf1() throws Exception {
		String solution = The_Matrix_Solver.solve(grid1, "GR2", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid1, solution));
	}
	...
	public void testf2() throws Exception {
		String solution = The_Matrix_Solver.solve(grid2, "GR2", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid2, solution));
	}
	...
	public void testf3() throws Exception {
		String solution = The_Matrix_Solver.solve(grid3, "GR2", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid3, solution));
	}
	...
	public void testf4() throws Exception {
		String solution = The_Matrix_Solver.solve(grid4, "GR2", false);
		assertTrue("The output actions do not lead to a goal state.", solution.equals("No Solution"));
	}
	
	@Test(timeout = 10000)
	public void testf5() throws Exception {
		String solution = The_Matrix_Solver.solve(grid5, "GR2", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid5, solution));
	}
	...
	public void testf6() throws Exception {
		String solution = The_Matrix_Solver.solve(grid6, "GR2", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid6, solution));
	}
	...
	public void testf7() throws Exception {
		String solution = The_Matrix_Solver.solve(grid7, "GR2", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid7, solution));
	}
	...
	public void testf8() throws Exception {
		String solution = The_Matrix_Solver.solve(grid8, "GR2", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid8, solution));
	}
	...
	public void testf9() throws Exception {
		String solution = The_Matrix_Solver.solve(grid9, "GR2", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid9, solution));
	}
	...
	public void testg0() throws Exception {
		String solution = The_Matrix_Solver.solve(grid0, "AS1", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid0, solution));
	}
	...
	public void testg1() throws Exception {
		String solution = The_Matrix_Solver.solve(grid1, "AS1", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid1, solution));
	}
	...
	public void testg2() throws Exception {
		String solution = The_Matrix_Solver.solve(grid2, "AS1", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid2, solution));
	}
	...
	public void testg3() throws Exception {
		String solution = The_Matrix_Solver.solve(grid3, "AS1", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid3, solution));
	}
	...
	public void testg4() throws Exception {
		String solution = The_Matrix_Solver.solve(grid4, "AS1", false);
		assertTrue("The output actions do not lead to a goal state.", solution.equals("No Solution"));
	}
	
	@Test(timeout = 10000)
	public void testg5() throws Exception {
		String solution = The_Matrix_Solver.solve(grid5, "AS1", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid5, solution));
	}
	...
	public void testg6() throws Exception {
		String solution = The_Matrix_Solver.solve(grid6, "AS1", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid6, solution));
	}
	...
	public void testg7() throws Exception {
		String solution = The_Matrix_Solver.solve(grid7, "AS1", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid7, solution));
	}
	...
	public void testg8() throws Exception {
		String solution = The_Matrix_Solver.solve(grid8, "AS1", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid8, solution));
	}
	...
	public void testg9() throws Exception {
		String solution = The_Matrix_Solver.solve(grid9, "AS1", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid9, solution));
	}
	...
	public void testgz10() throws Exception {
		String solution = The_Matrix_Solver.solve(grid10, "AS1", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid10, solution));
	}
	...
	public void testh0() throws Exception {
		String solution = The_Matrix_Solver.solve(grid0, "AS2", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid0, solution));
	}
	...
	public void testh1() throws Exception {
		String solution = The_Matrix_Solver.solve(grid1, "AS2", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid1, solution));
	}
	...
	public void testh2() throws Exception {
		String solution = The_Matrix_Solver.solve(grid2, "AS2", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid2, solution));
	}
	...
	public void testh3() throws Exception {
		String solution = The_Matrix_Solver.solve(grid3, "AS2", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid3, solution));
	}
	...
	public void testh4() throws Exception {
		String solution = The_Matrix_Solver.solve(grid4, "AS2", false);
		assertTrue("The output actions do not lead to a goal state.", solution.equals("No Solution"));
	}
	
	@Test(timeout = 10000)
	public void testh5() throws Exception {
		String solution = The_Matrix_Solver.solve(grid5, "AS2", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid5, solution));
	}
	...
	public void testh6() throws Exception {
		String solution = The_Matrix_Solver.solve(grid6, "AS2", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid6, solution));
	}
	...
	public void testh7() throws Exception {
		String solution = The_Matrix_Solver.solve(grid7, "AS2", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid7, solution));
	}
	...
	public void testh8() throws Exception {
		String solution = The_Matrix_Solver.solve(grid8, "AS2", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid8, solution));
	}
	...
	public void testh9() throws Exception {
		String solution = The_Matrix_Solver.solve(grid9, "AS2", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid9, solution));
	}
	...
	public void testhz10() throws Exception {
		String solution = The_Matrix_Solver.solve(grid10, "AS2", false);
		solution = solution.replace(" ", "");
		assertTrue("The output actions do not lead to a goal state.", applyPlan(grid10, solution));
	}
